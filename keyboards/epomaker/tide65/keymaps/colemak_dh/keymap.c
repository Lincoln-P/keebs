...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT( /* Base layer */
        ...
        TAB_CAPS,   KC_Q,       KC_W,       KC_F,       KC_P,       KC_B,       KC_J,       KC_L,       KC_U,       KC_Y,       KC_SCLN,    KC_LBRC,    KC_RBRC,    KC_BSLS,    KC_DEL,
        MO(1),      GUI_A,      ALT_R,      CTL_S,      SFT_T,      KC_G,       KC_M,       KC_N,       KC_E,       KC_I,       KC_O,       KC_QUOT,    KC_ENT,                 KC_HOME,
